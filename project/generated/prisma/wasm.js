...
exports.Prisma.DisenoPersonalizadoScalarFieldEnum = {
  id: 'id',
  userId: 'userId',
  tipoJoya: 'tipoJoya',
  tipoMetal: 'tipoMetal',
  ...
  dimensionesEsmeralda: 'dimensionesEsmeralda',
  quilatesAproximados: 'quilatesAproximados',
  presupuestoIndicado: 'presupuestoIndicado',
  descripcion: 'descripcion',
  referenciasImagenes: 'referenciasImagenes',
...
exports.Prisma.EsmeraldaScalarFieldEnum = {
  id: 'id',
  codigo: 'codigo',
  nombre: 'nombre',
  descripcion: 'descripcion',
...
exports.Prisma.ProductoScalarFieldEnum = {
  ...
  calidadEsmeralda: 'calidadEsmeralda',
  origenEsmeralda: 'origenEsmeralda',
  quilatesEsmeralda: 'quilatesEsmeralda',
  dimensionesEsmeralda: 'dimensionesEsmeralda',
  precio: 'precio',
...
exports.TipoConsulta = exports.$Enums.TipoConsulta = {
  VIRTUAL: 'VIRTUAL',
...
exports.TipoJoya = exports.$Enums.TipoJoya = {
  ANILLO: 'ANILLO',
...
exports.TipoMetal = exports.$Enums.TipoMetal = {
  ORO_AMARILLO_18K: 'ORO_AMARILLO_18K',
  ORO_BLANCO_18K: 'ORO_BLANCO_18K',
  ORO_ROSA_18K: 'ORO_ROSA_18K',
  PLATINO: 'PLATINO',
  PLATA_925: 'PLATA_925'
};

exports.CorteEsmeralda = exports.$Enums.CorteEsmeralda = {
...
exports.CalidadEsmeralda = exports.$Enums.CalidadEsmeralda = {
  PREMIUM: 'PREMIUM',
  ALTA: 'ALTA',
  MEDIA: 'MEDIA',
  COMERCIAL: 'COMERCIAL'
...
exports.OrigenEsmeralda = exports.$Enums.OrigenEsmeralda = {
  COLOMBIA_MUZO: 'COLOMBIA_MUZO',
  COLOMBIA_CHIVOR: 'COLOMBIA_CHIVOR',
  COLOMBIA_COSCUEZ: 'COLOMBIA_COSCUEZ',
  ZAMBIA: 'ZAMBIA',
  BRASIL: 'BRASIL',
  ETIOPIA: 'ETIOPIA',
  OTRO: 'OTRO'
...
exports.EstadoDisenoPersonalizado = exports.$Enums.EstadoDisenoPersonalizado = {
  PENDIENTE: 'PENDIENTE',
